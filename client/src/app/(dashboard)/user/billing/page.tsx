...
const UserBilling = () => {
    ...
    const { data: transactions, isLoading: isLoadingTransctions } = 
    ...
    transactions?.filter((transaction) => {
        const matchesTypes = paymentType === "all" 
